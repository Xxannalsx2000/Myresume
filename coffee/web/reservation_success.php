...
<?php
    ...
    if(isset($_POST['name']) && $_POST['time'] != null){
    $sql= "INSERT INTO reservation (name,time,people,mobile,created_at,memberID) VALUES (:name,:time,:people,:mobile,:created_at,:memberID)";
    $sth = $db ->prepare($sql);
    ...
    $sth ->execute();
    header("refresh:1; url=member_only_order.php");
} ?>
...
<div class="col-md-4 p-3 mx-auto" >
          <div class="bg-primary card " > <img class="img-fluid rounded-circle w-75 mx-auto mt-3" src="../images/coffee_cir.jpg" alt="Card image">
            <div class="card-body">
              <h4 class="card-title" style="font-weight:bold;">Reservation success!</h4>
              <p class="card-text" style="font-weight:bold;">Congratulations on the successful appointment Please enjoy your meal on time!.</p>
